...
- llama.cpp の in-process ローカル LLM サービス。既定は CPU-only。

Shader editing、MCP、automation bridge、runtime shader compilation、DXR/path tracing、Vulkan、mesh shader 実験は v1 では意図的に対象外です。
